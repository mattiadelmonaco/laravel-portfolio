...
@section('page')
    ...
    <form class="form-control d-flex flex-column gap-3 py-3" action="{{ route('types.store') }}" method="POST">
        @csrf
        ...
        <div class="d-flex flex-column gap-1">
            ...
            <textarea name="description" id="description" rows="5" class="rounded-1 border-1 px-2 py-1" required></textarea>
        </div>
