...
@section('title', 'Modifica questa tecnologia')

@section('page')

    <form class="form-control d-flex flex-column gap-3 py-3" action="{{ route('technologies.update', $technology->id) }}"
        method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="d-flex flex-column gap-1">
            ...
            <input type="color" name="color" id="color" class="rounded-1 border-1 px-2 py-1"
